    ...
    public BoardDTO(IGwent gwent) {
        ...
        for(int i = 0; i < gwent.getBoard().numberOfCards("close", 1); i++) {
            cardsOnFieldPlayer1[i] = new CardDTO(gwent.getBoard().getCard(i, 1).getCardName(),
                    gwent.getBoard().getCard(i, 1).getCardID(), "close");
        }
        ...
        for(int i = 0; i < gwent.getBoard().numberOfCards("close", 2); i++) {
            cardsOnFieldPlayer2[i] = new CardDTO(gwent.getBoard().getCard(i, 2).getCardName(),
                    gwent.getBoard().getCard(i, 2).getCardID(), "close");
        }

        rangedPlayer1 = new CardDTO[gwent.getBoard().numberOfCards("ranged", 1)];
        for(int i = 0; i < gwent.getBoard().numberOfCards("ranged", 1); i++) {
            rangedPlayer1[i] = new CardDTO(gwent.getBoard().getCard(i, 1).getCardName(),
                    gwent.getBoard().getCard(i, 1).getCardID(), "ranged");
        }

        rangedPlayer2 = new CardDTO[gwent.getBoard().numberOfCards("ranged", 2)];
        for(int i = 0; i < gwent.getBoard().numberOfCards("ranged", 2); i++) {
            rangedPlayer2[i] = new CardDTO(gwent.getBoard().getCard(i, 2).getCardName(),
                    gwent.getBoard().getCard(i, 2).getCardID(), "ranged");
        }

        siegePlayer1 = new CardDTO[gwent.getBoard().numberOfCards("siege", 1)];
        for(int i = 0; i < gwent.getBoard().numberOfCards("siege", 1); i++) {
            siegePlayer1[i] = new CardDTO(gwent.getBoard().getCard(i, 1).getCardName(),
                    gwent.getBoard().getCard(i, 1).getCardID(), "siege");
        }

        siegePlayer2 = new CardDTO[gwent.getBoard().numberOfCards("siege", 2)];
        for(int i = 0; i < gwent.getBoard().numberOfCards("siege", 2); i++) {
            siegePlayer2[i] = new CardDTO(gwent.getBoard().getCard(i, 2).getCardName(),
                    gwent.getBoard().getCard(i, 2).getCardID(), "siege");
        }
    }
}
